...
function Section02() {
  ...
  return (
    <section>
      <Summary icon="document/article-fill" label="최신 작성 글">
        {/* <Anchor css={styledAnchor} to={`/@${id}/posts`} underline="hover">
          전체 글 보기
        </Anchor> */}
      </Summary>
      <Spacer y={2} />
...
const PostsLoader = ({ author }: PostLoaderProps) => {
